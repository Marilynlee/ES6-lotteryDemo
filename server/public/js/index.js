	...
	var Base = function () {
	    ...
	    _createClass(Base, [{
	        ...
	        value: function addCodeItem(code, type, typeName, count) {
	            var self = this;
	            var tpl = '<li codes="' + type + '|' + code + '" bonus="' + count * 2 + '" count="' + count + '">\n\t\t <div class="code">\n\t\t\t <b>' + typeName + (count > 1 ? '复式' : '单式') + '</b>\n\t\t\t <b class="em">' + code + '</b>\n\t\t\t [' + count + '\u6CE8,<em class="code-list-money">' + count * 2 + '</em>\u5143]\n\t\t </div>\n\t </li>';
...
/***/ (function(module, exports) {
	...
	var Calculate = function () {
	    ...
	    _createClass(Calculate, [{
	        ...
	        /**
	         * @des  [computeCount  计算注数]
	         * @param {number} active[当前选中的号码数]
	         * @param {string} play_name[当前玩法标志]
	         * @return {number}  [注数]
	         * @author Lyn
	         * @date 2018/07/24 18:04:55
	         */
	        ...
	        /**
	         * @des  [computeBonus 计算金额]
	         * @param {number} active[当前选中的号码数]
	         * @param {string} play_name[当前玩法标志]
	         * @return {array}
	         * @author Lyn
	         * @date 2018/07/25 11:39:44
	         */
	        ...
	        /**
	         * @des  [combine 组合运算]
	         * @param {string} arr[参与组合运算的数组]
	         * @param {number} size[组合运算的基数]
	         * @return {[number]} 计算注数
	         * @author Lyn
	         * @date 2018/07/24 18:15:18
	         */
